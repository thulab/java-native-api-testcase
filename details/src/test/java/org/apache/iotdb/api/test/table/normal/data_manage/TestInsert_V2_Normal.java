package org.apache.iotdb.api.test.table.normal.data_manage;
...
/**
 * Title：测试插入数据—正常情况
 * Describe：测试各种方式的数据插入的操作，以及自动创建情况
 * Author：肖林捷
 * Date：2024/12/29
 */
...
//         判断是否符合预期
        assert expect == actual : "TestInsert_V2_Normal 的 insert 实际不一致期待：" + expect + "，实际：" + actual;
    }
...
//         插入数据
    ...
    public void insert_autoTable() throws IoTDBConnectionException, StatementExecutionException, IOException {
        ...
        // 判断是否符合预期
        assert expect == actual : "TestInsert_V2_Normal 的 insert_autoTable 实际不一致期待：" + expect + "，实际：" + actual;

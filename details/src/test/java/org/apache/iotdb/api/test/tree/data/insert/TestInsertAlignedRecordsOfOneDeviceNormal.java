...
/**
 * <p>Title：测试 InsertAlignedRecordsOfOneDevice 接口插入数据—正常情况<p/>
 * <p>Describe：测试使用 InsertAlignedRecordsOfOneDevice 接口插入各种数据类型的数据，包括BOOLEAN、INT32、INT64、FLOAT、DOUBLE、TEXT、STRING、BLOB、TIMESTAMP和DATE<p/>
 * <p>Author：肖林捷<p/>
 * <p>Date：2024/12/29<p/>
 */
public class TestInsertAlignedRecordsOfOneDeviceNormal extends BaseTestSuite_TreeModel {
    // 数据库名称
    private static final String database = "root.testInsertAlignedRecordsOfOneDevice";
    // 非对齐设备名称

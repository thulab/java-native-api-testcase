...
public class TestInsertAlignedStringRecordsOfOneDevice_Inference_Normal extends BaseTestSuite_TreeModel {
    // 数据库名称
...
//                out.println("line[" + (i + 1) + "]=" + line[i + 1]); // 打印当前行的列值
    ...
    public void afterMethod(int expectAligned, String msg) throws IoTDBConnectionException, StatementExecutionException {
        ...
        //out.println("InsertAlignedStringRecordsOfOneDevice_Inference_Normal 测试通过");
        // 打印清理数据的消息
//        out.println("清理数据");
        // 清理非对齐时间序列的数据

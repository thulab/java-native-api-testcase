 ...
 * <p>Date：2024/12/29<p/>
 */
public class TestInsertRecordsNormal extends BaseTestSuiteTreeModel {
    // 数据库名称
    ...
    /**
     * 测试 insertRecords 方法接口（构造方法2）
     */
    @Test(priority = 20)
    public void insertRecords2() throws IOException, IoTDBConnectionException, StatementExecutionException {
        // insertRecords(

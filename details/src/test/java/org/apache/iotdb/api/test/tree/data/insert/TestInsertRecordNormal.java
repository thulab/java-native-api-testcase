 ...
 * <p>Date：2024/12/29<p/>
 */
public class TestInsertRecordNormal extends BaseTestSuiteTreeModel {
    // 数据库名称
    ...
    /**
     * 测试 insertRecord 方法接口（重构方法1）
     */
    @Test(priority = 10) // 测试执行的优先级为10
    public void insertRecord1() throws IOException, IoTDBConnectionException, StatementExecutionException {
        // 遍历获取的单行数据，为设备添加值
    ...
    /**
     * 测试 insertRecord 方法接口（重构方法2）
     */
    @Test(priority = 20)
    public void insertRecord2() throws IOException, IoTDBConnectionException, StatementExecutionException {
